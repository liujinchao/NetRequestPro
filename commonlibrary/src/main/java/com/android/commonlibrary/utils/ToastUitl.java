...
public class ToastUitl {
    ...
    private static Toast initToast(CharSequence message, int duration) {
        if (toast == null) {
            toast = Toast.makeText(AppLibContext.getAppContext(), message, duration);
        } else {
    ...
    public static void showShort(int strResId) {
        initToast(AppLibContext.getAppContext().getResources().getText(strResId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showLong(int strResId) {
        initToast(AppLibContext.getAppContext().getResources().getText(strResId), Toast.LENGTH_LONG).show();
    }
...
//    }
    ...
    public static Toast setToastLayout(final int toastLayout, int gravity) {
        if (toast2 == null) {
            toast2 = new Toast(AppLibContext.getAppContext());
        }
        View view = LayoutInflater.from(AppLibContext.getAppContext()).inflate(toastLayout, null);
        toast2.setView(view);
